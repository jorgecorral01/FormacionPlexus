...
namespace Kata1{
    public class ConfigureWardrobe{
        public List<Valor> GiveBetterBoxForWall(){
            ...
            var posibilidadesCincoCajas = cajas.SelectMany(caja1 => cajas.SelectMany(caja2 => cajas.SelectMany(caja3 => cajas.SelectMany(caja4 => cajas.Select(caja5 => new Valor { Cajas = caja1.Width.ToString() + "-" + caja2.Width.ToString() + "-" + caja3.Width.ToString() + "-" + caja4.Width.ToString() + "-" + caja5.Width.ToString(), Suma = caja1.Width + caja2.Width + caja3.Width + caja4.Width + caja5.Width, Coste = caja1.Coste + caja2.Coste + caja3.Coste + caja4.Coste + caja5.Coste }))))).ToList();
